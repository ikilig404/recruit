...
import fxb.java.recruit.util.RecPositionUtil;
...
public class PositionServiceImpl implements PositionService {
    ...
    public PositionEntity getPositionById(int positionId) {
        PositionEntity positionById = positionMapper.getPositionById(positionId);
        return positionById;
    }
    ...
    public int updatePositionState(int statePub, int posId) {
        System.out.println(statePub + " " + posId);
    ...
    @Override
    public ArrayList<PositionEntity> listPosAll() {
        return positionMapper.listPosAll();
    }

    @Override
    public ArrayList<PositionCompanyBO> listAllPosCompany() {
        return positionMapper.listAllPosCompany();
    }
}
