...
public interface ApplicationMapper {
    ...
    ApplicationEntity getApplication(@Param("posId") int posId, @Param("resumeId") int resumeId);
    ...
    @Delete("delete from application where resumeId = #{resumeId} and positionId = #{posId}")
    int removeApplication(@Param("resumeId") int resumeId,@Param("posId") int posId);

    @Delete("delete from application where applicationId = #{applicationId}")
    int removeApplicationById(@Param("applicationId") int applicationId);
}
