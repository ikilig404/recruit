...
public class ArithmeticUtil {
    ...
    public ArrayList<PositionCompanyBO> popularityRec(HashMap<Integer, Integer> map, UserEntity user) {
        ...
        for (PositionEntity pos : listPosAll) {
            ...
            while (iter.hasNext()) {
                ...
                if (key == pos.getPositionId()) {                            //getTitle -> getPositionId
                    pv = (Integer) entry.getValue();  // 将职位的点击量赋值给pv数
                }
            }
        ...
        Collections.sort(compareList, (o1, o2) -> o2.getValue().compareTo(o1.getValue()));
...
//基于用户的协同过滤算法
    ...
    public ArrayList<PositionEntity> synergyUserRec(UserEntity user) {
        ...
        TreeMap<Double, Integer> simMap = new TreeMap<>((o1, o2) -> {
            if ((o2 - o1) < 0) {
                return -1;
            } else if ((o2 - o1) == 0) {
                return 0;
        ...
        for (UserEntity u : listUserAll) {
            ...
            //将单位 键值对 加入到 colMap中
            colMap.put(u.getUserId(), tagArray);
        }
    ...
    public ArrayList<PositionCompanyBO> synergyItemRec(UserEntity user) {
        ...
        Collections.sort(defaultEntryList, (o1, o2) -> o2.getValue().compareTo(o1.getValue()));
        ...
        Collections.sort(similarEntryList, (o1, o2) -> o2.getValue().compareTo(o1.getValue()));
